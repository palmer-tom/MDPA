...
AddTriAtomicArray(7, 7, 0, 0, 0, 0, 0, T, 0)
AddCircAtomicArray(4, -3e-9, -4e-9, 0, 0, 0, T, 1);
AddRectAtomicArray(8, 8, 3e-9, -4e-9, 0, 0, 0, T, 2)
% vy0 = -sqrt(0.02*Ep/Mass1);
% AddRectAtomicArray(4,4,0,12*AtomSpacing,0,vy0,0,T,1);
Ep = 2;
AddParticleStream(10, 0.1, 10, 0, 1, Ep * C.q_0, 5);
